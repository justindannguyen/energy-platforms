 ...
 */
package com.justin.transmission;
 ...
 */
public class CloudClient implements MqttCallback {
  ...
  public CloudClient(final RunConfiguration runConfiguration) throws MqttException {
    ...
    if (runConfiguration.getBrokerPassword() != null) {
      this.mqttConnectOpts.setPassword(runConfiguration.getBrokerPassword().toCharArray());
    }
    if (runConfiguration.getBrokerUsername() != null) {
      this.mqttConnectOpts.setUserName(runConfiguration.getBrokerUsername());
    }

    this.mqttClient =
        new MqttClient(runConfiguration.getBrokerUrl(), runConfiguration.getGatewayId());
